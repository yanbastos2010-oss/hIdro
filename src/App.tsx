      ...
      <section className="bg-white py-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { name: "Rosane", role: "Professora", text: "Me salvou! Eu já não sabia mais o que inventar nas aulas. O pessoal tem amado e as turmas estão sempre cheias agora.", img: "https://i.ibb.co/60prFBrv/Captura-de-tela-2026-01-24-154310.png" },
              { name: "Roberto", role: "Professor", text: "Muito prático. Eu abro o celular antes da aula, escolho uma dinâmica rápida e passo pra turma. O pessoal se diverte demais.", img: "https://i.ibb.co/Cp0qS9vz/Captura-de-tela-2026-04-05-051329.png" },
              { name: "Cláudia", role: "Professora", text: "Valeu muito a pena. As aulas saíram daquela mesmice de sempre e agora tenho um monte de material pra usar.", img: "https://i.ibb.co/G3WxRCGM/Captura-de-tela-2026-04-26-033446.png" }
            ].map((t, i) => (
